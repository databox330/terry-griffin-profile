...
export default function Home() {
  ...
  const meta = {
    title: "Terry Griffin - Full Stack Engineer",
    description: `Global-Minded Full-Stack software engineer with years of experience working in a bunch of different fields like eCommerce, Fintech, Blockchain, Data Management and building SaaS.`,
    image: "/Me_.png",
    type: "website",
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://waison-lee.vercel.app/`} />
        <link rel="canonical" href={`https://waison-lee.vercel.app/`} />
        ...
        <meta name="twitter:site" content="@leewaison1029" />
      ...
      {!isBlackListed ? (
        <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full ">
          ...
          {context.sharedState.finishedLoading ? (
            <Footer githubUrl={"https://github.com/databox330/"} hideSocialsInDesktop={true} />
          ) : (
            <></>
          )}
        </div>
