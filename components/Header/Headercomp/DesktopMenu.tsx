...
export default function DesktopMenu(props: { finishedLoading: boolean }) {
  return (
    <div className="text-md md:flex hidden flex-row items-center space-x-8 ">
      <motion.div
        initial={{
          y: -40,
          opacity: 0,
      ...
      >
        <ReactScrollLink to="aboutSection" spy={true} smooth={true} offset={-100} duration={200}>
          <span className="text-white hover:cursor-pointer hover:text-black duration-300 text-[18px]">About</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        <ReactScrollLink to="WhereIhaveWorkedSection" spy={true} smooth={true} offset={-300} duration={200}>
          <span className="text-white  hover:cursor-pointer hover:text-black duration-300 text-[18px]">Experience</span>
        </ReactScrollLink>
      </motion.div>
      <motion.div
        initial={{
      ...
      >
        <ReactScrollLink to="GetInTouchSection" spy={true} smooth={true} offset={-100} duration={200}>
          <span className="text-white  hover:cursor-pointer hover:text-black duration-300 text-[18px]">Contact</span>
        </ReactScrollLink>
      </motion.span>
    </div>
  );
